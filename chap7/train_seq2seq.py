...
from common.optimizer import Adam  # optimizer
from common.trainer import Trainer
from common.util import eval_seq2seq  # 정답률 측정
...
class PeekyDecoder:
    ...
    def forward(self, xs, h):
        ...
        out = self.embed.forward(xs)  # embedding계층
        ...
        out = np.concatenate((hs, out), axis=2)  # hs와 lstm 계층 출력에 연결
