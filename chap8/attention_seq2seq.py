...
1. AttentionEncoder 클래스: Encoder 클래스에서 LSTM 계층의 모든 은닉상태 반환
2. AttentionDecoder 클래스 : 어텐션 이용한 Decoder 계층
    : time embedding -> time LSTM -> Time attention -> time Affine
3. AttentionSeq2seq 클래스 구현 : AttentionEncoder, AttentionDecoder 연결
'''
